...
export function LandingPageEditForm({ clients, landingPage }: LandingPageEditFormProps) {
      ...
      <FormSection title="Client Ownership">
        ...
        <div className="grid grid-cols-2 gap-4">
          ...
          <div className="flex flex-col gap-2">
            ...
            <p className="text-xs leading-5 text-[#64748B]">
              Only active landing pages are publicly accessible.
            </p>
          ...
          <div className="flex flex-col gap-2">
            ...
            {landingPage.logo_url && (
              <div className="mb-2 flex items-center gap-3">
                <div 
                  className="size-10 rounded-full bg-cover bg-center border border-[#E2E8F0]" 
                  style={{ backgroundImage: `url(${landingPage.logo_url})` }}
                />
                <span className="text-xs text-[#64748B]">Current Logo</span>
              </div>
            )}
            <Input
              id="logo"
              ...
              className="h-[42px] rounded-[10px] border-[#E2E8F0] bg-white text-sm file:mr-4 file:py-1 file:px-4 file:rounded-full file:border-0 file:text-xs file:font-semibold file:bg-[#F1F5F9] file:text-[#475569] hover:file:bg-[#E2E8F0]"
            />
            <p className="text-xs leading-5 text-[#64748B]">
              Leave blank to keep the current logo. Upload a PNG, JPG, or WEBP. Max 5 MB.
            </p>
          ...
          <div className="flex flex-col gap-2">
            ...
            <p className="text-xs leading-5 text-[#64748B]">
              {landingPage.tracking?.capi_token_last4
                ? `Existing token: ••••${landingPage.tracking.capi_token_last4}`
                : "No CAPI token saved."}
            </p>

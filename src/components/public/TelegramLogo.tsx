...
export function TelegramLogo({ logoUrl, channelName }: TelegramLogoProps) {
  if (logoUrl) {
    return (
      <Image
        ...
        height={104}
        unoptimized
        className="size-[92px] rounded-full border-4 border-white object-cover shadow-[0_8px_24px_rgba(15,23,42,0.16)] sm:size-[104px]"
      />
    );
  }
  ...
  return (
    <div
      ...
      className="flex size-[92px] items-center justify-center rounded-full border-4 border-white bg-[#0F172A] text-4xl font-extrabold text-white shadow-[0_8px_24px_rgba(15,23,42,0.16)] sm:size-[104px]"
    >
